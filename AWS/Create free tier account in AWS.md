Before create AWS account should know something there is two type of users **Root User** and **IAM User**. because AWS is very carefully mange and control there will should have very sensitive and expensive data if any mistake happen it will cause for loss so much money and broke company. 
...
![alt text](screenshot/Pasted-image-20260429004217.png)
...
- Next is enter strong password for the root user
- Then contact information select for personal our own project then enter the phone number and address 
...
![alt text](screenshot/Pasted-image-20260429012728.png)
...
![alt text](screenshot/Pasted-image-20260429014350.png)
